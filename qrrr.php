...
<?php
	...
	if(isset($_POST['ans'])){
		...
		if (($answer=="utsav")) {
			...
			echo "win";
			echo '<img height="300" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://localhost/codeshastra/qrrrr.php">';
								?><a href="qrrrr.php">Next clue</a> <?php
